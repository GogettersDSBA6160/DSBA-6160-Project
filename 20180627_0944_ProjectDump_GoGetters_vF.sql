...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`pjamison`@`%`*/ /*!50003 TRIGGER DROPOWNER
...
--
-- Table structure for table `Owner_Deleted`
--

DROP TABLE IF EXISTS `Owner_Deleted`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Owner_Deleted` (
  `OwnerDeletedID` int(11) NOT NULL AUTO_INCREMENT,
  `OwnerID` int(11) NOT NULL,
  `First_Name` varchar(45) DEFAULT NULL,
  `Last_Name` varchar(45) DEFAULT NULL,
  `Street_Address` varchar(45) DEFAULT NULL,
  ...
  PRIMARY KEY (`OwnerDeletedID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Owner_Deleted`
--

LOCK TABLES `Owner_Deleted` WRITE;
/*!40000 ALTER TABLE `Owner_Deleted` DISABLE KEYS */;
INSERT INTO `Owner_Deleted` VALUES (1,501,'Peter','Butler','5 Trade St',NULL,'Charlotte','N','28202','Mecklenburg',5555555555,'pbutler@fakemailaddress.org','2018-06-27 05:53:49');
/*!40000 ALTER TABLE `Owner_Deleted` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`pjamison`@`%`*/ /*!50003 TRIGGER DROPPET
AFTER DELETE ON Pet
FOR EACH ROW
	BEGIN
...
--
-- Table structure for table `Pet_Deleted`
--

DROP TABLE IF EXISTS `Pet_Deleted`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Pet_Deleted` (
  `PetDeletedID` int(11) NOT NULL AUTO_INCREMENT,
  `PetID` int(11) NOT NULL,
  `Pet_Name` varchar(45) DEFAULT NULL,
  `OwnerID` int(11) NOT NULL,
  `TypeID` int(11) NOT NULL,
  ...
  `Comment` varchar(45) DEFAULT NULL,
  `Date_Deleted` datetime NOT NULL,
  PRIMARY KEY (`PetDeletedID`),
  KEY `fk_Pet_Owner_idx` (`OwnerID`),
  KEY `fk_Pet_Type1_idx` (`TypeID`),
  KEY `fk_Pet_Size1_idx` (`SizeID`),
  CONSTRAINT `OwnerID` FOREIGN KEY (`OwnerID`) REFERENCES `Owner` (`OwnerID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `SizeID` FOREIGN KEY (`SizeID`) REFERENCES `Size` (`SizeID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `TypeID` FOREIGN KEY (`TypeID`) REFERENCES `Type` (`TypeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Pet_Deleted`
--

LOCK TABLES `Pet_Deleted` WRITE;
/*!40000 ALTER TABLE `Pet_Deleted` DISABLE KEYS */;
INSERT INTO `Pet_Deleted` VALUES (1,160,'Spartacus',10,1,'M',4,'Gentle Giant','2018-06-27 05:38:04'),(2,160,'Spartacus',3,1,'M',4,'Gentle Giant','2018-06-27 05:46:50');
/*!40000 ALTER TABLE `Pet_Deleted` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-06-27  9:45:35
